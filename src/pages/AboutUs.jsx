...
<div class="bg-white relative   flex items-center  n justify-center overflow-hidden z-50 ">
        ...
        <div class="flex flex-col items-center justify-between lg:flex-row py-16">
            <div class=" relative ">
                ...
                <div class="lg:max-w-xl lg:pr-5 relative z-40">
                    ...
                    <div class="mt-10 flex flex-col items-center md:flex-row">
                        <a href="/categories" class="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-green-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                            View More</a>
                        <a href="/" aria-label="" class="group inline-flex items-center font-semibold text-g1">Watch how
                            it works
                            <svg xmlns="https://images.pexels.com/photos/3865676/pexels-photo-3865676.jpeg" class="ml-4 h-6 w-6 transition-transform group-hover:translate-x-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
                ...
                <div class="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                     <img src="https://images.pexels.com/photos/3865676/pexels-photo-3865676.jpeg"/>
                </div>
            </div>
        </div>
    </div> 
    ...
    <div class=" absolute -bottom-24 left-10 z-0  opacity-10 "> 
        {/* <svg width="800px" height="800px" viewBox="0 0 24 24" class="w-96 z-0  h-full    object-fill fill-gray-300 text-gray-300" fill="none" xmlns="">
    ...
    <div class=" absolute -bottom-0 left-3/4 z-0  opacity-10 "> 
        <svg width="800px" height="800px" viewBox="0 0 256 256" xmlns="https://images.pexels.com/photos/3865676/pexels-photo-3865676.jpeg" class="w-48 z-0  h-full -rotate-90   object-fill fill-red-300 text-red-300">
    ...
    <div class=" absolute top-10 left-3/4 z-0  opacity-10 "> 
        ...
        <svg fill="#000000" width="800px" height="800px" viewBox="0 0 256 256" xmlns="https://images.pexels.com/photos/3865676/pexels-photo-3865676.jpeg" class="w-96 z-0  h-full    object-fill fill-blue-300 text-blue-300">
